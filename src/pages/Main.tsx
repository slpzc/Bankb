...
const Main = () => {
    return (
        <>
            <h1>Алексей <svg width="12" height="22" viewBox="0 0 12 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <p className="description-paragraph">Спасибо, что Вы с нами!</p>
            <div className="spend-in-mouth">
                <SpendInMouth/>
            </div>
            <UserCards/>
            <h2>Наш блог</h2>
